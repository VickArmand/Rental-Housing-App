  ...
  <div class="container">
    ...
    <div v-else>
      ...
      >
        ...
        >
          <label for="loginEmail" class="form-label col">Email:</label>
          <input
            type="email"
        ...
        <div
          class="d-flex justify-content-between align-items-center gx-3 py-3"
        >
          <label for="loginPassword" class="form-label col">Password:</label>
          <input
            type="password"
            class="form-control col"
            name=""
...
export default {
  ...
  data() {
    return {
      ...
      loginUrl: `${process.env.VUE_APP_API_URL}/api/login/`,
      response: null,
    };
  },
  created() {
